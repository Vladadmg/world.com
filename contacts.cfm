...
<p><strong><font size="2" color="#ff9900">Inquiries:</font></strong></p></p>
		...
		<form name="mailform" method="post" action="/contacts.cfm?mailform_action=send">
			<input type="hidden" name="_formName" value="65316_90022"><input type="hidden" name="_return" value="/contacts.cfm"><span style="display:none;"><input id="profession" name="profession" size="30" type="text" value="" /></span>
			<center>
			<table class="mail">
				<tr>
					<th>Subject:</th>
				...
				<tr>
						<td colspan="2" id="captcha_90022" class="captcha" align="center">
						<p>Please type the text that appears in the picture below:</p>
						<p><input type="text" name="captchaText" size="20"></p>
						
						<p><img src="/go/captcha-display?captcha_hr=3C22E2E9-DA00-BF50-006F915200EA2FD6" />
						<input name="captchaHash" type="hidden" value="3C22E2E9-DA00-BF50-006F915200EA2FD6" /></p>
						</td>
						
							<script language="javascript">
								jQuery('#captcha_90022').attr('display', 'none');
							</script>
