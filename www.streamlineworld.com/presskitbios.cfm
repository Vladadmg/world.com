<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
		<html>
			...
			<title>Streamline - presskitbios</title>
...
<p>&nbsp;</p></p>
		...
		<form name="mailform" method="post" action="/presskitbios.cfm?mailform_action=send">
			<input type="hidden" name="_formName" value="63324_125591"><input type="hidden" name="_return" value="/presskitbios.cfm"><span style="display:none;"><input id="profession" name="profession" size="30" type="text" value="" /></span>
			<center>
			<table class="mail">
				<tr>
					<th>Subject:</th>
				...
				<tr>
						<td colspan="2" id="captcha_125591" class="captcha" align="center">
						<p>Please type the text that appears in the picture below:</p>
						<p><input type="text" name="captchaText" size="20"></p>
						
						<p><img src="/go/captcha-display?captcha_hr=3C230B52-9D4E-61E7-B6BE256F0D659087" />
						<input name="captchaHash" type="hidden" value="3C230B52-9D4E-61E7-B6BE256F0D659087" /></p>
						</td>
						
							<script language="javascript">
								jQuery('#captcha_125591').attr('display', 'none');
							</script>
